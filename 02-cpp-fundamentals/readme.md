...
## Template Class
- It is used so that same code can be used for different data type.
...
int main()
{
  Arithmetic<int> ar(10, 5); // used for int data type
  cout << ar.add() << endl;
  Arithmetic<float> ar1(1.5, 1.2); // used for float data type
  {
    cout << ar1.add() << endl;
  }
}
